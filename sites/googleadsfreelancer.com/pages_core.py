...
"body": """
<section><div class="wrap">
<h2>What a Google Ads consultant does that a manager does not</h2>
<p>Management is the weekly work inside the account. Consulting is the layer above it: deciding what the account is for, how it should be structured, what to measure, and whether the people running it are doing the right things. Most companies buy management and get no consulting, because the person running the account has neither the seniority nor the incentive to question the setup they inherited.</p>
<p>I offer Google Ads consulting in three shapes. All of them are delivered by me, in writing and on calls, and none of them require you to move the account.</p>
<div class="cols">
<div class="card"><h3>Strategy and structure</h3><p>How budget should split across Search, Shopping, Performance Max and YouTube; how campaigns should map to margin, service line and geography; what a realistic cost per customer is given your auction. Delivered as a written plan your team or agency can execute.</p></div>
<div class="card"><h3>Second opinion on an agency or freelancer</h3><p>You suspect the account is under-managed but cannot prove it. I review the account, the reporting and the invoices, and tell you plainly what is being done well, what is not, and what to ask for. The <a href="/google-ads-audit/">audit</a> is the formal version of this.</p></div>
<div class="card"><h3>Advisory for in-house teams</h3><p>A standing monthly or fortnightly session with the person who runs your ads: reviewing changes, unblocking decisions, and building the judgement that courses do not teach. Often called Google Ads coaching; it is closer to a fractional head of paid search.</p></div>
</div>
</div></section>

<section><div class="wrap">
<h2>The problems that usually bring someone to a consultant</h2>
<ul>
<li><strong>The numbers do not agree.</strong> Google Ads reports one conversion count, GA4 another, the CRM a third, and nobody will say which one is real. Until that is fixed, every optimisation decision is built on sand. This is where I start, every time.</li>
<li><strong>Clicks are cheaper and leads are worse.</strong> The account is being optimised towards a metric that is easy to move rather than the one that pays the bills. Usually a conversion action problem, sometimes a bidding strategy problem, occasionally both.</li>
<li><strong>Spend went up and revenue did not.</strong> Broad match and Performance Max expand happily into demand you were already capturing for free, including your own brand. Exclusions and structure fix it; more budget does not.</li>
<li><strong>The agency report is three pages of green arrows.</strong> Impressions up, CTR up, CPC down, and the sales team quietly hiring a second SDR to qualify the leads. A consultant with no retainer to protect reads that report differently.</li>
<li><strong>A new market, product or platform.</strong> Launching in Canada or the UK, adding Shopping, moving from lead forms to booked calls. The decisions made in the first month set the cost base for the next year.</li>
</ul>
</div></section>
...
"service_name": "Google Ads audit",
"proof": [("1", "fixed price, quoted up front"), ("5–7", "working days to deliver"), ("0", "obligation afterwards"), ("14+", "years reading accounts")],
"body": """
<section><div class="wrap">
<h2>What a PPC audit usually uncovers</h2>
<p>Different companies, different industries, and the same short list of problems. These are the ones that show up in most Google Ads audits I run, roughly in order of how much money they waste.</p>
<div class="cols">
<div class="card"><h3>Conversions counted more than once</h3><p>The same lead fires as a form submission, a thank-you pageview and a phone call. Your reported cost per lead is fiction, and Smart Bidding has been optimising towards the fiction for months.</p></div>
<div class="card"><h3>Search terms nobody has read</h3><p>In neglected accounts, a double-digit share of budget routinely goes to queries that will never convert: job seekers, students, competitors' brand names, the wrong country.</p></div>
<div class="card"><h3>Structure built for the tool</h3><p>Campaigns organised by match type or by whoever built them, instead of by margin, service line and geography, which is what you actually make decisions on.</p></div>
<div class="card"><h3>Automation on defaults</h3><p>Broad match with Smart Bidding and no negatives. Performance Max with no brand exclusion, quietly buying demand you already had. Auto-applied recommendations switched on.</p></div>
<div class="card"><h3>Budget where the margin is not</h3><p>The cheapest service to sell receives the most budget because it produces the most conversions, while the profitable one is capped. Correct by the platform's logic, wrong by yours.</p></div>
<div class="card"><h3>Landing pages that leak</h3><p>Ads promising one thing, pages offering another; forms that fail on mobile; call buttons that are not tracked. The account can be perfect and still lose here.</p></div>
</div>
</div></section>
...
<li><div><strong>Landing pages and conversion path.</strong> Message match, speed on mobile, form and call tracking, what happens after the lead arrives.</div></li>
</ol>
<p>The deliverable is a written document with findings ranked by financial impact, each with the fix, who should do it and how to confirm it worked, plus a short call to walk through it. Accounts on Microsoft Advertising or Meta can be added to the same audit; see <a href="/ppc-management/">PPC management</a> and <a href="/meta-ads-management/">Meta Ads</a>.</p>
</div></section>
...
<div class="cols">
<div class="card"><h3>Percentage of ad spend</h3><p>Typically 10% to 20% of monthly spend, often with a minimum. Easy to understand, and the incentive runs backwards: the consultant earns more when you spend more, not when you spend better. Watch what happens when the honest advice is to cut budget.</p></div>
...
<div class="card"><h3>Hourly</h3><p>Rates vary enormously with seniority and market. Fine for audits and advisory. Bad for ongoing management, because you start hesitating before asking a question, which is exactly when accounts drift.</p></div>
</div>
...
<section><div class="wrap">
<h2>What freelance Google Ads management typically costs</h2>
<p>Ranges observed across the US and UK markets, for context rather than as a quote. Freelancer rates cluster lower than agency rates for the same spend because there is no account manager, office or margin stack in between; senior freelancers sit at the top of the freelance range and overlap with small agencies.</p>
<table>
...
"meta": "Freelance Google Ads results: 44% lower CPA for a Houston HVAC company, 600% startup sales growth in eight months, $21M B2B revenue from $1.5M in media, and what each number does and does not prove.",
"kicker": "Results",
...
"proof": [("44%", "lower CPA, Houston HVAC & plumbing"), ("600%", "sales growth in 8 months, Pontomais"), ("$21M", "B2B revenue from $1.5M in media, 2025"), ("3 months", "early on a 5,000-student target")],
"body": """
<section><div class="wrap">
...
("Do you work in industries other than home services and healthcare?", "Yes: B2B SaaS and HR tech, education, e-commerce, professional services and local services are the other main groups. Industry pages with more detail are on <a href=\"https://diwizi.com/\" rel=\"noopener\">diwizi.com</a>."),
...
"related": ["google-ads-management", "google-ads-audit", "about", "small-business-ppc-management"],
},
...
<li><strong>Reporting for owners.</strong> Cost per customer, revenue where it can be measured, what changed and why. Not click counts.</li>
