...
"lead": "Most PPC consultants in London are one person working from home who meets clients twice a year. I am the same, from a different postcode: 14+ years on the account, UK hours, everything in writing, and a fee that does not carry a London office inside it.",
"service_name": "PPC consultancy for London businesses",
"body": """
<section><div class="wrap">
<h2>What London accounts usually need</h2>
<p>London auctions are the most expensive in the UK for almost every service category: legal, financial, medical, property, B2B software. A click that costs £4 in Leeds costs £11 in Zone 1, and the same mistakes cost proportionally more. The work is the same everywhere; the tolerance for waste is lower here.</p>
<ul>
<li><strong>Location targeting that matches how you actually serve.</strong> "London" is thirty-two boroughs and a commuter belt. Bids by borough and by hour, with the office postcode radius separated from the wider catchment.</li>
<li><strong>Enquiry quality over enquiry count.</strong> Call tracking tied to the keyword, form fields that qualify, and CRM stages fed back to Google and LinkedIn so the bidding learns from clients, not from clicks.</li>
<li><strong>A landing page per intent.</strong> Not the homepage, and not one generic "contact us" page for twelve services.</li>
<li><strong>Competitor and brand defence handled deliberately.</strong> Whether to bid on your own name in a crowded market is a calculation, not a reflex.</li>
</ul>
</div></section>

<section><div class="wrap">
<h2>Remote, and honest about it</h2>
<p>I do not have a London office and I will not pretend otherwise on this page. What I offer instead: calls on UK time, a weekly written update, access to the accounts and the reporting at any hour, and a fee without the overhead. In-person meetings can be arranged for larger engagements when I am in the UK, which is a few times a year. If you need someone in the room every month, a London agency is the better choice and I will say so on the call.</p>
</div></section>
...
<div class="card"><h3><a href="/b2b-ppc/">B2B and LinkedIn</a></h3><p>For the London B2B and SaaS crowd: pipeline reported, not leads.</p></div>
</div>
</div></section>
""",
"faq": [
...
"meta": "An honest comparison of PPC agencies and independent PPC consultants for UK businesses: who does the work, how each charges, what is in scope, and when the agency is the better choice.",
"kicker": "Choosing",
